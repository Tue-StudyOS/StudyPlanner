...
def _emit_course(
    ...
    *,
    ...
    plan.courses.append({
        ...
        "number": (details.get("fields") or {}).get("Nummer") or None,
        "catalog_title": course.get("title") or "",
        "organisation": (details.get("fields") or {}).get("Heimat-Einrichtung"),
        "course_type": (details.get("fields") or {}).get("Veranstaltungsart"),
        "offering_frequency": (details.get("fields") or {}).get("Angebotshäufigkeit"),
        "registration_period": (details.get("fields") or {}).get("Anmeldegruppe"),
        "short_comment": (details.get("fields") or {}).get("Kurzkommentar"),
        "semester_hours": _maybe_float((details.get("fields") or {}).get("Semesterwochenstunden")),
